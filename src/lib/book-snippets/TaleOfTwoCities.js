  ...
  return (
    <article id="tale-of-two-cities" className="book-snippet">
      <div className="book-info">
        <h1 className="book-title">A Tale of Two Cities</h1>
        <p className="subtitle">A Story of the French Revolution</p>
        <p className="attribution">
          <span className="author">Charles Dickens</span>
        </p>
      </div>
      ...
      <h2 className="story-info">
        <span className="story-number">Book the First</span>
        <span className="story-title">Recalled to Life</span>
      </h2>

      <div className="chapter">
        <h3 className="chapter-info">
          <span className="chapter-number">I</span>
          <span className="chapter-title">The Period</span>
        </h3>

        <p className="emphasis">
          It was the best of times,<br />it was the worst of times,<br /> it was the
          age of wisdom,<br /> it was the age of foolishness,<br /> it was the epoch
          of belief,<br /> it was the epoch of incredulity,<br /> it was the season
          of Light,<br /> it was the season of Darkness,<br /> it was the spring of
          hope,<br /> it was the winter of despair,
        </p>
