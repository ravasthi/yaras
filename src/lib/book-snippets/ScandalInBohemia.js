    ...
    <article id="scandal-in-bohemia" className="book-snippet">
      <div className="book-info">
        <h1 className="book-title">
          The Adventures of{' '}
          <span className="keep-together">Sherlock Holmes</span>
        </h1>
      ...
      <div className="chapter">
        ...
        <p>
          To Sherlock Holmes she is always <em>the</em> woman. I have seldom
        ...
        <p>
          ...
          Your Majesty, as I understand, became entangled with this young
